 ...
 * 
 */
public class ZabbixRestResponseDecoderV2<APIResponseType> extends 
		BaseRestResponseDecoder {

	public ZabbixRestResponseDecoderV2(Class<APIResponseType> c) {
		super();
		this.defaultDecodeStrategy = new ZabbixRRDStrategy<APIResponseType>(c);
	}
	
	public ZabbixRestResponseDecoderV2(@SuppressWarnings("rawtypes") Class... c) {
		super();
		this.defaultDecodeStrategy = new ZabbixRRDStrategyV2<APIResponseType>(c);
	}
