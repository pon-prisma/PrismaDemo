...
public class ZabbixMonitoredHostResponseV2_4 {
	...
	private List<ZabbixTemplateResponse> parentTemplates = new ArrayList<ZabbixTemplateResponse>();
	@JsonProperty("items")
	private List<ZabbixItemResponse> items = new ArrayList<ZabbixItemResponse>();
	 ...
	 */
	@JsonProperty("parentTemplates")
	public List<ZabbixTemplateResponse> getParentTemplates() {
	 ...
	 */
	@JsonProperty("parentTemplates")
	public void setParentTemplates(List<ZabbixTemplateResponse> parentTemplates) {
	 ...
	 */
	@JsonProperty("items")
	public List<ZabbixItemResponse> getItems() {
		return items;
	}
	 ...
	 */
	@JsonProperty("items")
	public void setItems(List<ZabbixItemResponse> items) {
		this.items = items;
	}
