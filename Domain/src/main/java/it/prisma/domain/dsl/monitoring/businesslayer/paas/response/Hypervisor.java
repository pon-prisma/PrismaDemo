...
@JsonPropertyOrder({ "service", "vcpusUsed", "hypervisorType", "localGbUsed",
		"hostIp", "hypervisorHostname", "id", "memoryMb", "currentWorkload",
		"vcpus", "freeRamMb", "runningVms", "free_disk_gb",
		"hypervisor_version", "disk_available_least", "localGb", "cpuInfo",
		"memoryMbUsed" })
public class Hypervisor {
	...
	public String toString() {
		return "Hypervisor [service=" + service + ", vcpusUsed=" + vcpusUsed
				+ ", hypervisorType=" + hypervisorType + ", localGbUsed="
				+ localGbUsed + ", hostIp=" + hostIp + ", hypervisorHostname="
				+ hypervisorHostname + ", id=" + id + ", memoryMb=" + memoryMb
				+ ", currentWorkload=" + currentWorkload + ", vcpus=" + vcpus
				+ ", freeRamMb=" + freeRamMb + ", runningVms=" + runningVms
				+ ", freeDiskGb=" + freeDiskGb + ", hypervisorVersion="
				+ hypervisorVersion + ", diskAvailableLeast="
				+ diskAvailableLeast + ", localGb=" + localGb + ", cpuInfo="
				+ cpuInfo + ", memoryMbUsed=" + memoryMbUsed + "]";
	}
