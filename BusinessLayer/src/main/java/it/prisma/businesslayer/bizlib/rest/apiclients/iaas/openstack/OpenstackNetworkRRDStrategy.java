 ...
 * 
 */
public class OpenstackNetworkRRDStrategy<APIResponseType> implements
		RestResponseDecodeStrategy {

	private Class<APIResponseType> targetClass;

	public OpenstackNetworkRRDStrategy(Class<APIResponseType> c) {
		targetClass = c;
	}
	...
	private Pair<StatusType, JavaType> strategy(RestMessage msg)
		...
		if (httpStatusCode >= 200 && httpStatusCode < 300 ) {
			...
			clazz = mapper.getTypeFactory()
					.constructType(ErrorWrapperNetwork.class);
		} else {
