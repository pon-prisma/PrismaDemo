 ...
 * 
 */
public class CloudifyRestResponseDecoder<APIResponseType> extends 
		BaseRestResponseDecoder {

	public CloudifyRestResponseDecoder(Class<APIResponseType> c) {
		super();
		this.defaultDecodeStrategy = new CloudifyRRDStrategy<APIResponseType>(c);
	}
